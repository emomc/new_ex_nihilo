...
public class InfestedLeavesRenderer implements BlockEntityRenderer<InfestedLeavesBlockEntity, InfestedLeavesRenderer.State> {
    ...
    @Override
    public void extractRenderState(InfestedLeavesBlockEntity leaves, State state, float partialTick, Vec3 cameraPos,
    ...
    public void submit(State state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector,
        ...
        RenderSubmitHelper.submitInfestingLeavesOverlay("infested", state.variant, 1.0F,
